defmodule Scryptex.Salsa20 do
  ...
  def hash(input, rounds) do
    ...
    <<x0::32, x1::32, x2::32, x3::32, x4::32, x5::32, x6::32, x7::32, x8::32, x9::32, x10::32,
      x11::32, x12::32, x13::32, x14::32,
      x15::32>> = for(<<x::little-32 <- input>>, into: "", do: <<x::32>>) |> core(rounds)

    <<x0::little-32, x1::little-32, x2::little-32, x3::little-32, x4::little-32, x5::little-32,
      x6::little-32, x7::little-32, x8::little-32, x9::little-32, x10::little-32, x11::little-32,
  ...
  def core(input, rounds) do
    ...
    <<sum(y0, x0)::32, sum(y1, x1)::32, sum(y2, x2)::32, sum(y3, x3)::32, sum(y4, x4)::32,
      sum(y5, x5)::32, sum(y6, x6)::32, sum(y7, x7)::32, sum(y8, x8)::32, sum(y9, x9)::32,
      sum(y10, x10)::32, sum(y11, x11)::32, sum(y12, x12)::32, sum(y13, x13)::32,
      sum(y14, x14)::32, sum(y15, x15)::32>>
  end
end
