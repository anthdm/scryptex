defmodule TripleSec.ScryptTest do
  use ExUnit.Case, async: true
  import TripleSec.Scrypt
  ...
  test "blockmix_salsa8" do
    input = endian_reverse hex_to_binary """
    ...
    output = endian_reverse hex_to_binary """
  ...
  # https://github.com/keybase/triplesec/blob/4b81c60de65f6072a51032833b1a1cbd618bfb05/test/files/scrypt.iced.
  test "scrypt" do
    [
      {"", "", 16, 1, 1, 1, 64, """
